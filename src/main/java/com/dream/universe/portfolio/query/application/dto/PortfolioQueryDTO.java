package com.dream.universe.portfolio.query.application.dto;
...
public class PortfolioQueryDTO {
    ...
    public PortfolioQueryDTO(){}

    public PortfolioQueryDTO(long portfolioCode, long memberCode, long portfolioIndex, String portfolioName, String portfolioLink) {
